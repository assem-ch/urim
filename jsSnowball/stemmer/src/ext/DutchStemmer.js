...
return true;sbp.cursor++;}}
function r_postlude(){var among_var,v_1;while(true){v_1=sbp.cursor;sbp.bra=v_1;among_var=sbp.find_among(a_1,3);if(among_var!=0){sbp.ket=sbp.cursor;switch(among_var){case 1:sbp.slice_from("y");break;case 2:sbp.slice_from("i");break;case 3:if(sbp.cursor>=sbp.limit){sbp.cursor=v_1;return true;}
sbp.cursor++;break;}}}}
...
function r_standard_suffix(){var among_var,v_1,v_2,v_3,v_4,v_5,v_6;v_1=sbp.limit-sbp.cursor;sbp.ket=sbp.cursor;among_var=sbp.find_among_b(a_3,5);if(among_var!=0){sbp.bra=sbp.cursor;switch(among_var){case 1:if(r_R1())
...
sbp.slice_del();break;}}
sbp.cursor=sbp.limit-v_1;if(sbp.out_grouping_b(g_v_I,73,232)){v_6=sbp.limit-sbp.cursor;if(!sbp.find_among_b(a_5,4)==0&&sbp.out_grouping_b(g_v,97,232)){sbp.cursor=sbp.limit-v_6;sbp.ket=sbp.cursor;if(sbp.cursor>sbp.limit_backward){sbp.cursor--;sbp.bra=sbp.cursor;sbp.slice_del();}}}
